                        ...
                        <form action="{{ route('emails.store') }}" method="POST">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-4">
                                            <input type="text" class="form-control @error('is_valid') is-invalid @enderror" name="is_valid" value="{{ old('is_valid') ?: '' }}" required/>
                                            @error('is_valid')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-4">
                                            <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" value="{{ old('status') ?: '' }}" required>
                                            @error('status')
