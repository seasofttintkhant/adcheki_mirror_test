...
@section('content')
@include('admin.partials.commons._content_header', ['title' => __('messages.edit_domain')])
                        ...
                        <form action="{{ route('domains.update', $domain->id) }}" method="POST">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-4">
                                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') ?: $domain->name }}" required></input>
                                            @error('name')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-4">
                                            <input type="text" name="ip" id="ip" class="form-control @error('ip') is-invalid @enderror" value="{{ old('ip') ?: $domain->default_ip }}" required></input>
                                            @error('ip')
